module.exports={
  ...
  "rules": {
    ...
    "semi": [2, "always"], // ??? 强制是否使用分号。always要求有封号，never不需要封号
    ...
    "comma-dangle": [2, "never"], // 要求或禁止使用拖尾逗号 never不使用拖尾逗号，always-multiline 添加拖尾逗号
    ...
    "quotes": [2, "double"], // 强制使用一致的单引号single/双引号double
